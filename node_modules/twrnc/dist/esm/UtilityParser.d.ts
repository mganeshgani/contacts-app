...
import type { StyleIR, DeviceContext, Version } from './types';
...
export default class UtilityParser {
    ...
    private isNegative;
    private context;
    constructor(input: string, config: TwConfig, cache: Cache, device: DeviceContext, reactNativeVersion: Version);
    parse(): StyleIR;
