...
const defaultStyles = [
    ...
    [`contents`, (0, helpers_1.complete)({ display: `contents` })],
    ...
    [`cursor-auto`, (0, helpers_1.complete)({ cursor: `auto` })],
    [`cursor-pointer`, (0, helpers_1.complete)({ cursor: `pointer` })],
    [`box-border`, (0, helpers_1.complete)({ boxSizing: `border-box` })],
    [`box-content`, (0, helpers_1.complete)({ boxSizing: `content-box` })],
    [`outline`, (0, helpers_1.complete)({ outlineStyle: `solid` })],
