...
exports.warn = exports.isArbitraryValue = exports.unconfiggedStyle = exports.parseUnconfigged = exports.parseAndConsumeDirection = exports.getDirection = exports.toPx = exports.toStyleVal = exports.parseStyleVal = exports.getStyle = exports.mergeStyle = exports.getCompleteStyle = exports.parseNumericValue = exports.complete = void 0;
...
function parseNumericValue(value, context = {}) {
    ...
    switch (match === null || match === void 0 ? void 0 : match[1]) {
        ...
        case `deg`:
            return [number, types_1.Unit.deg];
        case `rad`:
            return [number, types_1.Unit.rad];
        default:
            return null;
    }
}
...
function toStyleVal(number, unit, context = {}) {
    ...
    switch (unit) {
        ...
        case types_1.Unit.deg:
        case types_1.Unit.rad:
...
exports.isArbitraryValue = isArbitraryValue;
