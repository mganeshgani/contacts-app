...
const user_select_1 = __importDefault(require("./resolve/user-select"));
const text_decoration_style_1 = __importDefault(require("./resolve/text-decoration-style"));
const outline_1 = require("./resolve/outline");
const filter_1 = require("./resolve/filter");
class UtilityParser {
    ...
    parseUtility() {
        ...
        if (this.consumePeeked(`select-`)) {
            style = (0, user_select_1.default)(this.rest);
            if (style)
                return style;
        }
        if (this.consumePeeked(`decoration-`)) {
            style = (0, text_decoration_style_1.default)(this.rest);
            if (style)
                return style;
            style = (0, color_1.color)(`decoration`, this.rest, theme === null || theme === void 0 ? void 0 : theme.colors);
            if (style)
                return style;
        }
        if (this.consumePeeked(`outline-`)) {
            if (this.consumePeeked(`offset-`)) {
                style = (0, outline_1.outlineOffset)(this.rest, this.isNegative, theme === null || theme === void 0 ? void 0 : theme.outlineOffset);
                if (style)
                    return style;
            }
            style = (0, outline_1.outlineWidth)(this.rest, theme === null || theme === void 0 ? void 0 : theme.outlineWidth);
            if (style)
                return style;
            style = (0, outline_1.outlineStyle)(this.rest);
            if (style)
                return style;
            style = (0, color_1.color)(`outline`, this.rest, theme === null || theme === void 0 ? void 0 : theme.colors);
            if (style)
                return style;
        }
        if (this.consumePeeked(`brightness-`)) {
            style = (0, filter_1.filterBrightness)(this.rest, this.context, theme === null || theme === void 0 ? void 0 : theme.brightness);
            if (style)
                return style;
        }
        if (this.consumePeeked(`contrast-`)) {
            style = (0, filter_1.filterContrast)(this.rest, this.context, theme === null || theme === void 0 ? void 0 : theme.contrast);
            if (style)
                return style;
        }
        if (this.consumePeeked(`saturate-`)) {
            style = (0, filter_1.filterSaturate)(this.rest, this.context, theme === null || theme === void 0 ? void 0 : theme.saturate);
            if (style)
                return style;
        }
        if (this.consumePeeked(`hue-rotate-`)) {
            style = (0, filter_1.filterHueRotate)(this.rest, this.context, theme === null || theme === void 0 ? void 0 : theme.hueRotate);
            if (style)
                return style;
        }
        if (this.consumePeeked(`grayscale`)) {
            style = (0, filter_1.filterGrayscale)(this.rest, this.context, theme === null || theme === void 0 ? void 0 : theme.grayscale);
            if (style)
                return style;
        }
        if (this.consumePeeked(`invert`)) {
            style = (0, filter_1.filterInvert)(this.rest, this.context, theme === null || theme === void 0 ? void 0 : theme.invert);
            if (style)
                return style;
        }
        if (this.consumePeeked(`sepia`)) {
            style = (0, filter_1.filterSepia)(this.rest, this.context, theme === null || theme === void 0 ? void 0 : theme.sepia);
            if (style)
                return style;
        }
